...
{ 
    ...
    PIDA.Position_KP 		= MyPidKp;		/*	位置环KP参数	*/
		...
		else
		{
			...
			else if(gSpeedR > target + 5 && gSpeedR <= target + 10)
			{
				MyPidKi = 0.701f;
			}
			else if(gSpeedR > target + 10)
			{
				MyPidKi = 0.601f;
			}				
...
//		if(gSpeedR > target-10 && target > 150)
//		{
//			if(StepState == 1)
//			{
//				Integral_bias = Integral_bias-2;Last_Bias = Last_Bias-2;Pwm = Pwm/1.2f;	
//			}
//		}
